...
export default function EditPostScreen() {
  ...
  }, [title, category, images, address, placeName, note, link, lat, lng, addressFromGps, displayCity, effectivePercent, originalPrice, discountedPrice, expiry, router, selectedCity, user, guestCity, id, updatePost]);

  if (loading) {
    return (
      <View style={[styles.root]}>
        <Stack.Screen options={{ headerShown: false }} />
        <PercentSpinnerCentered size={64} />
      </View>
    );
  }
  ...
  return (
    <View style={fieldStyles.field}>
      <View style={fieldStyles.labelRow}>
        <View style={fieldStyles.labelAccent} />
